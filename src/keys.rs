...
pub fn rsskeygen(count_messages: usize, params: &Params) -> (SKrss, PKrss) {
    ...
    let X_tilde = &params.g_tilde * &x; // Calculate X~, ok
    ...
    // i_exponent seems correct uses values 1 to n
    //println!("{:?}",i_exponent);
...
mod tests {
    ...
    fn test_rsskeygen() {
        ...
        // key generation seems to be okay from me. Error should be elsewhere...
